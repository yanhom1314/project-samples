...
/***/ function(module, exports, __webpack_require__) {
	...
	var _veeLocaleCn = __webpack_require__(4);
	...
	var app6 = new _vue2.default({
	    ...
	    methods: {
	        ...
	        ajax: function ajax() {
	            ...
	            (0, _fetch2.default)('/data/hello.json').then(function (response) {
	                return response.json();
	            }).then(function (data) {
	                app6.message = JSON.stringify(data);
	            }).catch(function (e) {
	        ...
	        html: function html() {
	            var msg = this.message;
	            (0, _fetch2.default)('/nothing.html').then(function (response) {
