...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vue_set = __webpack_require__(2);

	console.log("$:jQuery:" + _vue_set.jQuery + " " + _vue_set.$);

	var app = new _vue_set.Vue({
	    el: '#app',
	    data: {
	        message: 'Hello Vue!'
	    }
	...
	var app2 = new _vue_set.Vue({
	    el: '#app-2',
	    data: {
	        message: 'You loaded this page on ' + new Date()
	    }
	});
	var app3 = new _vue_set.Vue({
	    el: '#app-3',
	    data: {
	        seen: true
	    }
	});
	var app4 = new _vue_set.Vue({
	    el: '#app-4',
	    data: {
	        list: [{ text: 'Learn JavaScript' }, { text: 'Learn Vue' }, { text: 'Build something awesome' }]
	    }
	});
	var app5 = new _vue_set.Vue({
	    el: '#app-5',
	    data: {
	...
	var app6 = new _vue_set.Vue({
	    ...
	    methods: {
	        ...
	        ajax: function ajax() {
	            ...
	            (0, _vue_set.fetch)('/data/hello.json').then(function (response) {
	        ...
	        html: function html() {
	            var msg = this.message;
	            (0, _vue_set.fetch)('/nothing.html').then(function (response) {
	...
	_vue_set.Vue.component('todo-item', {
	    props: ['todo'],
	    template: '<li>{{ todo.text }}</li>'
	});

	var app7 = new _vue_set.Vue({
	    el: '#app-7',
	    data: {
	...
	var app8 = new _vue_set.Vue({
	    el: "#app8"
	});

	//window.onload
	(0, _vue_set.$)(function () {
	    (0, _vue_set.$)("#_close").click(function () {
	        console.log("_close");
	    });
	    (0, _vue_set.$)("#_save").click(function () {
	        console.log("_save");
	    });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.$ = exports.jQuery = exports.fetch = exports.Validator = exports.Vue = undefined;
	...
	var _veeLocaleCn = __webpack_require__(6);

	var _veeLocaleCn2 = _interopRequireDefault(_veeLocaleCn);
	...
	var config = {
	    ...
	    dictionary: {
	        cn: {
	            messages: _veeLocaleCn2.default
	        }
	    }
	};
	...
	exports.Validator = _veeValidate.Validator;
